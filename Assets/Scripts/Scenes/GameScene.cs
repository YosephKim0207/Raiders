...
public class GameScene : BaseScene {
    ...
    const int defaultRegenTime = 17;
    float _respawnCycle = 10.0f;
    GameObject _enemy;
    GameObject _rootUI;
    GameObject go;
    ...
    protected void CallEndingPopup() {
        Manager.Sound.StopAll();
        Manager.Sound.Play("BGM/RipAndTear", SoundType.BGM, 0.4f);
